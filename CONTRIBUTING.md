...
1. [Fork](https://github.com/quic/SvUTest/fork) and clone the repository.
    
    ```bash
    git clone https://github.com/quic/SvUTest.git
    ``` 
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/quic/SvUTest.git
    ```
...
1. [Submit a pull request](https://github.com/quic/SvUTest/pulls) from your branch to `main`.
